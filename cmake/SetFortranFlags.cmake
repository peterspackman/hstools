...
elseif("${CMAKE_Fortran_COMPILER_ID}" MATCHES "GNU")
    ...
    set(RELEASE_FLAGS "-O2 -funroll-loops -finline-functions")
elseif("${CMAKE_Fortran_COMPILER_ID}" MATCHES "NAG")
    set(COMPILER "NAG_nagfor")
    set(CMAKE_Fortran_FLAGS "${CMAKE_Fortran_FLAGS} -info -kind=byte -maxcontin=1023 -f2008 -free -gc")
    set(DEBUG_FLAGS "-O0 -g -gline -mtrace -C -C=undefined -colour -w=uei")
    set(RELEASE_FLAGS "-w -O4 -no_underflow_warning")
else()
