...
def main():
  ...
  parser = argparse.ArgumentParser(description= """
       ...
       perform clustering on the generated fingerprints using various statistical tests,
       generate and output the percentage contribution to the surface of various elements.
       """, prog=progname)
  ...
  parser.add_argument('-f','--file',metavar='FILENAME', 
                      help='generate information about percentage contribution to the \
                      hirshfeld surface contained in FILENAME.')
  ...
  if opts.file:
    ...
    contrib, contrib_p = calc.get_contrib_percentage(atoms,de_face_atoms,di_face_atoms)
